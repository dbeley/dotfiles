...
*** org-ref
    #+begin_src emacs-lisp
      (use-package org-ref
        :ensure t
        :config
        (setq reftex-default-bibliography '("~/Nextcloud/3. org/Stage/Articles.bib"))

        ;; see org-ref for use of these variables
        (setq org-ref-bibliography-notes "~/Nextcloud/3. org/Stage/Notes_articles.org"
              org-ref-default-bibliography '("~/Nextcloud/3. org/Stage/Articles.bib")
              org-ref-pdf-directory "~/Nextcloud/6. Cours/Stage/Articles/")

        (setq bibtex-completion-notes-path "~/Nextcloud/3. org/Stage/Articles.org"
              bibtex-completion-bibliography "~/Nextcloud/3. org/Stage/Articles.bib"
              bibtex-completion-library-path "~/Nextcloud/6. Cours/Stage/Articles/")
