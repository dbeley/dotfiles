...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (telephone-line spaceline-config spaceline emms esup counsel use-package ranger projectile ox-twbs ox-reveal org-plus-contrib org-bullets no-littering magit htmlize helm exwm-x evil-surround elpy company-quickhelp better-defaults base16-theme airline-themes ace-window))))
(custom-set-faces
